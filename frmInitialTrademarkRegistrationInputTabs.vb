Public Class frmInitialTrademarkRegistrationInputTabs
    ...
    Private Sub frmInitialTrademarkRegistrationInputTabs_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        With Me
            ...
            rdoTitleTypeOfTMOfficialActions = "1. Official Action Type"
            ...
            rdoTitleTypeOfTMOfficialActions = "2. Official Action Type"
            .grpTypeOfActionReceived.Controls.Add(rdoArrayTypeOfTMOfficeActions.AddNewRadioButton(rdoTitleTypeOfTMOfficialActions, LeftTypeOfTrademark, TopTypeOfTrademark))

            rdoTitleTypeOfTMOfficialActions = "3. Official Action Type"
            .grpTypeOfActionReceived.Controls.Add(rdoArrayTypeOfTMOfficeActions.AddNewRadioButton(rdoTitleTypeOfTMOfficialActions, LeftTypeOfTrademark, TopTypeOfTrademark))

            rdoTitleTypeOfTMOfficialActions = "4. Official Action Type"
            .grpTypeOfActionReceived.Controls.Add(rdoArrayTypeOfTMOfficeActions.AddNewRadioButton(rdoTitleTypeOfTMOfficialActions, LeftTypeOfTrademark, TopTypeOfTrademark))

            LeftTypeOfTrademark = 350 '530  '500 represents the start of a new Column of Radio Buttons
            TopTypeOfTrademark = 15  '8 '10 '20  '1

            rdoTitleTypeOfTMOfficialActions = "5. Official Action Type"
            .grpTypeOfActionReceived.Controls.Add(rdoArrayTypeOfTMOfficeActions.AddNewRadioButton(rdoTitleTypeOfTMOfficialActions, LeftTypeOfTrademark, TopTypeOfTrademark))

            rdoTitleTypeOfTMOfficialActions = "6. Official Action Type"
            .grpTypeOfActionReceived.Controls.Add(rdoArrayTypeOfTMOfficeActions.AddNewRadioButton(rdoTitleTypeOfTMOfficialActions, LeftTypeOfTrademark, TopTypeOfTrademark))

            rdoTitleTypeOfTMOfficialActions = "7. Official Action Type"
            .grpTypeOfActionReceived.Controls.Add(rdoArrayTypeOfTMOfficeActions.AddNewRadioButton(rdoTitleTypeOfTMOfficialActions, LeftTypeOfTrademark, TopTypeOfTrademark))

            rdoTitleTypeOfTMOfficialActions = "8. Official Action Type"
            .grpTypeOfActionReceived.Controls.Add(rdoArrayTypeOfTMOfficeActions.AddNewRadioButton(rdoTitleTypeOfTMOfficialActions, LeftTypeOfTrademark, TopTypeOfTrademark))
            ...
            rdoTitleTypeOfTMResponseMade = "1. Response Made Type"
            ...
            rdoTitleTypeOfTMResponseMade = "2. Response Made Type"
            .grpTypeOfResponseMade.Controls.Add(rdoArrayTypeOfTMResponseMade.AddNewRadioButton(rdoTitleTypeOfTMResponseMade, LeftTypeOfTrademark, TopTypeOfTrademark))

            rdoTitleTypeOfTMResponseMade = "3. Response Made Type"
            .grpTypeOfResponseMade.Controls.Add(rdoArrayTypeOfTMResponseMade.AddNewRadioButton(rdoTitleTypeOfTMResponseMade, LeftTypeOfTrademark, TopTypeOfTrademark))
    ...
    Private Sub btnResetThisActionAndResponse_Click(sender As Object, e As EventArgs) Handles btnResetThisActionAndResponse.Click
        ...
        Select Case SequenceNumberToUse
                Case 1
                    ...
                    TypeOfFirstPatentOfficeResponse = ""
                Case 2
                    SecondUSPTOActionMailingDate = 0
                    SecondUSPTOActionResponseDueDate = 0
                    SecondUSPTOActionResponseMadeDate = 0
                    TypeOfSecondUSPTOAction = ""
                    TypeOfSecondPatentOfficeResponse = ""
                Case 3
                    ThirdUSPTOActionMailingDate = 0
                    ThirdUSPTOActionResponseDueDate = 0
                    ThirdUSPTOActionResponseMadeDate = 0
                    TypeOfThirdUSPTOAction = ""
                    TypeOfThirdPatentOfficeResponse = ""
                Case 4
                    FourthUSPTOActionMailingDate = 0
                    FourthUSPTOActionResponseDueDate = 0
                    FourthUSPTOActionResponseMadeDate = 0
                    TypeOfFourthUSPTOAction = ""
                    TypeOfFourthPatentOfficeResponse = ""
                Case 5
                    FifthUSPTOActionMailingDate = 0
                    FifthUSPTOActionResponseDueDate = 0
                    FifthUSPTOActionResponseMadeDate = 0
                    TypeOfFifthUSPTOAction = ""
                    TypeOfFifthPatentOfficeResponse = ""
                Case 6
                    SixthUSPTOActionMailingDate = 0
                    SixthUSPTOActionResponseDueDate = 0
                    SixthUSPTOActionResponseMadeDate = 0
                    TypeOfSixthUSPTOAction = ""
                    TypeOfSixthPatentOfficeResponse = ""
                Case 7
                    SeventhUSPTOActionMailingDate = 0
                    SeventhUSPTOActionResponseDueDate = 0
                    SeventhUSPTOActionResponseMadeDate = 0
                    TypeOfSeventhUSPTOAction = ""
                    TypeOfSeventhPatentOfficeResponse = ""
                Case 8
                    EighthUSPTOActionMailingDate = 0
                    EighthUSPTOActionResponseDueDate = 0
                    EighthUSPTOActionResponseMadeDate = 0
                    TypeOfEighthUSPTOAction = ""
                    TypeOfEighthPatentOfficeResponse = ""
                Case 9
                    NinthUSPTOActionMailingDate = 0
                    NinthUSPTOActionResponseDueDate = 0
                    NinthUSPTOActionResponseMadeDate = 0
                    TypeOfNinthUSPTOAction = ""
                    TypeOfNinthPatentOfficeResponse = ""
                Case 10
                    TenthUSPTOActionMailingDate = 0
                    TenthUSPTOActionResponseDueDate = 0
                    TenthUSPTOActionResponseMadeDate = 0
                    TypeOfTenthUSPTOAction = ""
                    TypeOfTenthPatentOfficeResponse = ""
                Case 11
                    EleventhUSPTOActionMailingDate = 0
                    EleventhUSPTOActionResponseDueDate = 0
                    EleventhUSPTOActionResponseMadeDate = 0
                    TypeOfEleventhUSPTOAction = ""
                    TypeOfEleventhPatentOfficeResponse = ""
                Case 12
                    TwelvethUSPTOActionMailingDate = 0
                    TwelvethUSPTOActionResponseDueDate = 0
                    TwelvethUSPTOActionResponseMadeDate = 0
                    TypeOfTwelvethUSPTOAction = ""
                    TypeOfTwelvethPatentOfficeResponse = ""
            End Select

        ''Now Enable or Disable the appropriate Controls
        'Select Case PatentTypeNumber
        '    Case 1 To 9
        '        .fraOfficialActionsAndResponses.Enabled = False
        '        .fraHaveThereBeenAnyOfficialActionsFromThePatentOffice.Enabled = False
        '        .lblHaveThereBeenAnyOfficialActionsFromThePatentOffice.Enabled = False
        '        For I = 0 To 1
        '            '    .optHaveThereBeenAnyOfficialActionsFromThePatentOffice(I).BackColor = &H8000000F  'ButtonFace
        '            .optHaveThereBeenAnyOfficialActionsFromThePatentOffice(I).Enabled = False
        '        Next I
        '    Case 10 To 18
        '        .fraOfficialActionsAndResponses.Enabled = True
        '        .fraOfficialActionsAndResponses.BackColor = &HC0E0FF  'Lightest Orange
        '        If .fraHaveThereBeenAnyOfficialActionsFromThePatentOffice.Enabled = True Then
        '            .fraHaveThereBeenAnyOfficialActionsFromThePatentOffice.Enabled = True
        '            .fraHaveThereBeenAnyOfficialActionsFromThePatentOffice.BackColor = &H80C0FF 'Light Orange
        '            .lblHaveThereBeenAnyOfficialActionsFromThePatentOffice.Enabled = True
        '            .lblHaveThereBeenAnyOfficialActionsFromThePatentOffice.BackColor = &H80C0FF 'Light Orange
        '            .optHaveThereBeenAnyOfficialActionsFromThePatentOffice(0).Enabled = True
        '            .optHaveThereBeenAnyOfficialActionsFromThePatentOffice(0).BackColor = &H80C0FF 'Light Orange
        '            .optHaveThereBeenAnyOfficialActionsFromThePatentOffice(1).Enabled = True
        '            .optHaveThereBeenAnyOfficialActionsFromThePatentOffice(1).BackColor = &H80C0FF 'Light Orange
        '        Else
        '            Call ShowFrameForAreThereAnyMoreActionsToBeEntered
        '        End If
        'End Select
